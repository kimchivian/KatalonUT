...
Mobile.setText(findTestObject('Object Repository/Forgot Password/Isiemailmu_edit_text'), 'hamburger4@yopmail.com', 30)

Mobile.tap(findTestObject('Object Repository/Forgot Password/Kirim_button'), 30)

Mobile.verifyElementExist(findTestObject('Object Repository/Forgot Password/Jikaemailkamuterdaftar_text'), 30)
...
Mobile.setText(findTestObject('Object Repository/Login/KataSandi_edit_text'), '', 30)
...
Mobile.tap(findTestObject('Object Repository/Forgot Password/Home_button'), 30)
